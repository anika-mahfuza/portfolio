...
export const VideoBackground = forwardRef<VideoBackgroundRef, VideoBackgroundProps>(function VideoBackground(
  ...
  return (
    <div className="fixed inset-0 z-0">
      ...
      {/* Vignette effect */}
      <div
        className={`absolute inset-0 vignette transition-opacity duration-1000 ${
          isActive ? "opacity-100" : "opacity-0"
        }`}
      />
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-t from-background via-transparent to-background/30 transition-opacity duration-1000 ${
          isActive ? "opacity-100" : "opacity-0"
        }`}
      />
    </div>
