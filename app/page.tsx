        ...
        >
          <div className="container mx-auto px-4 py-12 md:py-16">
            ...
            <section className="min-h-[80vh] flex items-center justify-center">
              <TiltCard tiltAmount={8} glareEnable glareMaxOpacity={0.1}>
                <GlassPanel className="max-w-lg text-center p-6 md:p-8">
            ...
            <section className="py-16">
              <FadeContent direction="up" distance={40}>
                <div className="max-w-3xl mx-auto">
                  <TiltCard tiltAmount={5} glareEnable glareMaxOpacity={0.08}>
                        ...
                        <div className="space-y-3">
                          <FadeContent delay={300} direction="left">
                            <Magnet strength={0.2} className="block">
                              <div className="glass rounded-lg p-3 transition-all duration-300 hover:bg-foreground/5">
                                <span className="text-xs text-accent uppercase tracking-wider">Languages</span>
                          ...
                          <FadeContent delay={500} direction="left">
                            <Magnet strength={0.2} className="block">
                              <div className="glass rounded-lg p-3 transition-all duration-300 hover:bg-foreground/5">
                                <span className="text-xs text-accent uppercase tracking-wider">Focus</span>
              ...
              <div className="max-w-3xl mx-auto">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    ...
                    { skill: "Web", level: "Proficient" },
                  ].map((item, i) => (
                    <FadeContent key={item.skill} delay={200 + i * 150} direction="up">
                      <Magnet strength={0.3}>
                        <TiltCard tiltAmount={12} glareEnable>
                          <GlassPanel className="p-4 text-center h-full">
                            <div className="text-lg font-semibold text-foreground mb-1">
                              <GlitchText text={item.skill} speed={60} />
                            </div>
                            <div className="text-xs text-muted-foreground uppercase tracking-wider">{item.level}</div>
                          </GlassPanel>
                        </TiltCard>
                      </Magnet>
                    </FadeContent>
            ...
            <section className="py-16">
              <FadeContent direction="up" distance={30}>
                <TiltCard tiltAmount={6} glareEnable glareMaxOpacity={0.12}>
                  <GlassPanel variant="strong" className="max-w-md mx-auto text-center p-6">
                    <h2 className="font-sans text-lg md:text-xl font-semibold text-foreground mb-3">
                      <DecryptedText text="Get in Touch" speed={40} />
                    </h2>
                    <FadeContent delay={200}>
